...
day_stream_url = 'http://stream.priyom.org:8000/pip-day.ogg'  # URL du stream pour la journée
night_stream_url = 'http://stream.priyom.org:8000/pip-night.ogg'  # URL du stream pour la nuit
...
async def on_ready():
    ...
    for guild in bot.guilds:
        ...
        voice_channel_name = "ThePIP Day" if is_daytime() else "ThePIP Night"
